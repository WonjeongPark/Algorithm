...
## 생각과정
```
[[의상이름,의상종류],[의상이름,의상종류]...]중에서 서로 다른 조합의 수는
[(같은 의상의종류의 수+1)*(같은 의상의종류의 수+1)...]-1 로 구할 수 있다.
각 의상의 종류의 수에 1을 더하는 것은 그 의상을 입지 않았을 경우의 수를 추가하는 것이고
마지막의 -1는 각각 의상을 입지않아 모든 것을 입지않은 경우를 빼는 것이다.
